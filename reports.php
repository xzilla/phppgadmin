<?php
	 ...
	 *
	 * $Id: reports.php,v 1.3 2003/02/23 12:51:32 chriskl Exp $
	 */
	...
	function doDefault($msg = '') {
		...
		if ($reports->recordCount() > 0) {
			...
			while (!$reports->EOF) {
				...
				echo "<td class=\"opbutton{$id}\"><a href=\"display.php?query={$query}&return_url={$return_url}&return_desc={$return_desc}\">{$strBrowse}</a></td>\n";
