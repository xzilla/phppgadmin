...
class DomainTest extends PreconditionSet
{
    ...
    function testCreateDomain()
    {
        ...
        $this->assertTrue($this->get($webUrl . '/domains.php?action=create&' .
    ...
    function testAlterDomain()
    {
        ...
        $this->assertTrue($this->get($webUrl . '/domains.php?action=propert' .
                                     'ies&database=test&schema=public&domain=spikedomain&'));
    ...
    function testAddCheck()
    {
        ...
        $this->assertTrue($this->get($webUrl . '/domains.php?action=properties&' .
                                     'database=test&schema=public&domain=spikedomain&'));
    ...
    function testDropConstraint()
    {
        ...
        $this->assertTrue($this->get($webUrl . '/domains.php?database=test&' .
                                     'schema=public&'));
        ...
        // Drop the constraint.
        $this->assertTrue($this->get($webUrl . '/domains.php?action=confirm_drop_con&' .
                                     'database=test&schema=public&constraint=newcheck&' .
                                     'domain=spikedomain&type=c'));
    ...
    function testDropDomain()
    {
        ...
        $this->assertTrue($this->get($webUrl . '/domains.php?action=confirm_drop&' .
                                     'database=test&schema=public&domain=spikedomain&'));
        $this->assertTrue($this->setField('cascade', TRUE));    
