...
class SecurityTest extends PreconditionSet 
{
    ...
    function testSpecialLogin() 
    {
        ...
        $this->login('postgres', $this->_invalidPassword, $webUrl . '/index.php');
        ...
        // Login with special user name "postgres".
        $this->login($NORMAL_USER_NAME, '', $webUrl . '/index.php');
    ...
    function testInvalidLogin() 
    {
        ...
        $this->login($this->_invalidUserName, $this->_invalidPassword, $webUrl . '/index.php');
        
        // Verify the error messages.
        $this->assertWantedText($lang['strloginfailed']);
        
        // Login with valid username and invalid password.
        $this->login($SUPER_USER_NAME, $this->_invalidPassword, $webUrl . '/index.php');
    ...
    function testAccount() 
    {
        ...
        $this->login($NORMAL_USER_NAME, $NORMAL_USER_PASSWORD, $webUrl . '/index.php');
        
        // Turn to the account page and change the password page.
        $this->assertTrue($this->get($webUrl . '/users.php?action=account'));
